...
public class EntityLittleMaidAvatar extends EntityPlayer implements IEntityLittleMaidAvatarBase
{
	...
	public EntityLittleMaidAvatar(World par1World, EntityLittleMaid par2EntityLittleMaid) {
		...
		this.dataWatcher.addObject(Statics.dataWatch_AbsorptionAmount, 0.0F);
